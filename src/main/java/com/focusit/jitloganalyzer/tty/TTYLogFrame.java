...
public class TTYLogFrame extends JFrame {
    ...
    public TTYLogFrame(java.util.List<TTYEvent> events, List<ClassLoadEvent> classLoading, HashMap<Long, List<TTYEvent>> jitCompilations, List<SweeperEvent> sweeping, HashMap<String, List<Long>> methodCompilations, Function<Void, Void> parseFunction) throws HeadlessException {
